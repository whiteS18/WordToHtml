...
public class ReadWordTable {
    ...
    public String readTable(XWPFTable table) throws IOException {
        ...
        StringBuilder tableToHtmlStr = new StringBuilder("<table border=\"1\" cellspacing=\"0\">");
    ...
    public  List<XWPFTable> getWordTables() {
        //这里参数为你想要转化成html文件的带表格的word文档位置，同样，全路径，
        try (FileInputStream fileInputStream = new FileInputStream("C:/demo/附件2：银联卡业务统计规范（业务口径）2019A版 (1).docx");
